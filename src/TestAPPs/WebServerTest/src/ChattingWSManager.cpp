...
ChattingWSManager::ChattingWSManager() {
    this->add_function("/ws", std::bind(&ChattingWSManager::ws_chat, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
    this->add_function("/ws_chat", std::bind(&ChattingWSManager::ws_chat, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
}


bool ChattingWSManager::ws_chat(Luna::ccWebsocket::ccWebSocketEvent eEvent, std::shared_ptr<Luna::ccWebsocket> pWS, const std::string strData) {
    switch ((int)eEvent) {
