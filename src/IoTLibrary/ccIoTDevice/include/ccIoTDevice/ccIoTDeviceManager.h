...
public:
    ...
    size_t  get_device_count() { return agent_map_.size(); }

    bool    sendControlCommand(int index, const std::string command);
...
protected:
    std::unordered_map < std::int32_t, std::shared_ptr<ccIoTDeviceAgent> > agent_map_;
